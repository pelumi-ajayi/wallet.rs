...
use crate::{
    account::{handle::AccountHandle, operations::transfer::TransferResult, types::OutputData, TransferOptions},
    Error,
};

use iota_client::bee_message::output::{AliasId, AliasOutputBuilder, FoundryId, Output};
...
impl AccountHandle {
    ...
    pub async fn burn_foundry(
        ...
        self.send(outputs, options, burn_native_token_remainder).await
    }
